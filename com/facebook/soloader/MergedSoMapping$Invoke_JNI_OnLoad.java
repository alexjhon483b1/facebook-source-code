...
public class MergedSoMapping$Invoke_JNI_OnLoad {
   public static native int libFBLiteDatabaseRedactor_jni_so();

   public static native int libLiteAdvancedCryptoTransportReinstallDataProviderPluginjni_so();

   public static native int libLiteE2EEExperimentsMobileConfigPluginjni_so();

   public static native int libLiteExperimentsMobileConfigPluginjni_so();

   public static native int libLiteMsysDasmConfigCreator_jni_so();

   public static native int libLiteMsysDatabaseSchemaDeployer_acg_so();

   public static native int libLiteMsysDatabaseSchemaDeployer_jni_so();

   public static native int libLiteMsysDatabaseSchemaDeployer_jninovt_so();

   public static native int libLiteMsysDatabaseSchemaDeployer_so();

   public static native int libLiteMsysDatabaseSchemaDeployernovt_so();

   public static native int libLiteMsysTableToCqlProcRegistration_jni_so();

   public static native int libLiteReceiveMetricIntegrationPluginjni_so();

   public static native int libMCIAppExperimentsPluginjni_so();

   public static native int libMEMMobileConfigPlatformFbLitePluginjni_so();

   public static native int libMsysIsDialtoneProviderPluginjni_so();

   public static native int libMsysTTRCPluginjni_so();

   public static native int libVideoJni_so();

   public static native int libactoverunity_so();
   ...
   public static native int libbreakpad_fatal_java_exception_description_handler_jni_so();

   public static native int libbreakpadabort_so();

   public static native int libc___demangle_so();

   public static native int libc___streams_so();
   ...
   public static native int libcomfacebookmillinstagramsecuremessagesharedfragmentutilsdirectsqlnativeopsjni_so();

   public static native int libcomfacebookmillmessengerencryptedmessagingmobileconfigcqlutilsdirectsqlnativeopsjni_so();

   public static native int libcomfacebookmillmsyscommondirectsqlnativeopsjni_so();

   public static native int libcomfacebookmillmsyscorequeriescqlexportsdirectsqlnativeopsjni_so();

   public static native int libcomfacebookmillmsystestcommondirectsqlnativeopsjni_so();

   public static native int libcomfacebookmillshimaddressabletransportsbasedirectsqlnativeopsjni_so();

   public static native int libcryptox_so();

   public static native int libctaudioprocessor_native_so();

   public static native int libdalvikdistract_so();
   ...
   public static native int libdomaininfoutils_jni_so();

   public static native int libdouble_conversion_so();

   public static native int libevloopmanager_jni_so();
   ...
   public static native int libimage_quality_utils_lite_so();

   public static native int libimagepipeline_so();

   public static native int libjni_mcpintegration_fblite_integrationPluginRegistry_so();
   ...
   public static native int liblitersysjni_so();

   public static native int liblivestreaming_rtmp_fblite_so();
   ...
   public static native int libmailboxfblitesdkjni_so();
   ...
   public static native int libmailboxlitecommonjni_so();
   ...
   public static native int libmailboxmsyslitejni_so();
   ...
   public static native int libmailboxsecureauthplatformvestajni_so();

   public static native int libmailboxshimjni_so();

   public static native int libmailboxstickerpackjni_so();

   public static native int libmailboxstickerstorejni_so();
   ...
   public static native int libmediastreaming_jni_so();
   ...
   public static native int libmessengerplatformloggertamlistenerjni_so();
   ...
   public static native int libmillcommonjni_so();

   public static native int libmillimmutablecursorjni_so();

   public static native int libmillruntimejni_so();

   public static native int libminscompiler_jni_so();

   public static native int libmnscertificateverifier_so();

   public static native int libmobilenetwork_jni_so();

   public static native int libmqttnonbridgednetworksessionplugin_so();

   public static native int libmsssim_so();
   ...
   public static native int libopenh264v211libdecoderAndroid_so();

   public static native int libopenh264v211libencoderAndroid_so();
   ...
   public static native int libprofilo_async_unwinder_so();
   ...
   public static native int libpytorch_jni_lite_so();

   public static native int libpytorch_vision_jni_so();

   public static native int libreliablemedia_so();

   public static native int libroi_align_ops_xplat_so();

   public static native int librsdevxagentjni_so();

   public static native int librsdevxcallagentjni_so();

   public static native int librstransportproxies_so();

   public static native int librsysaudioeventsjni_so();

   public static native int librsysaudiojni_so();

   public static native int librsysaudiomixerholderjni_so();

   public static native int librsysaudiomodulejni_so();

   public static native int librsysbasejni_so();

   public static native int librsyscallcontextjni_so();

   public static native int librsyscallinfojni_so();

   public static native int librsyscallintentjni_so();

   public static native int librsyscalljni_so();

   public static native int librsyscallmanagercallclientjni_so();

   public static native int librsyscallmanagerjni_so();

   public static native int librsyscamerajni_so();

   public static native int librsyscryptocontextfactoryjni_so();

   public static native int librsyscryptojni_so();

   public static native int librsysdatachanneljni_so();

   public static native int librsysdevicestatsjni_so();

   public static native int librsysdominantspeakerjni_so();

   public static native int librsysendedjni_so();

   public static native int librsysexecutionjni_so();

   public static native int librsysfileloggingjni_so();

   public static native int librsysgroupexpansionjni_so();

   public static native int librsyslogjni_so();

   public static native int librsysmediajni_so();

   public static native int librsysmediastatsjni_so();

   public static native int librsysmessagequeuejni_so();

   public static native int librsysoutgoingcallconfigjni_so();

   public static native int librsysoverlayconfigmanagerjni_so();

   public static native int librsyspollsjni_so();

   public static native int librsysroomtypecallingjni_so();

   public static native int librsysstatejni_so();

   public static native int librsysstreamjni_so();

   public static native int librsystransportjni_so();

   public static native int librsystslogjni_so();

   public static native int librsysturnallocationjni_so();

   public static native int librsysturnallocationmsysjni_so();

   public static native int librsysvideoeffectjni_so();

   public static native int librsysvideoescalationjni_so();

   public static native int librsysvideojni_so();

   public static native int librsysvideorenderjni_so();

   public static native int librsysvideosubscriptionsjni_so();

   public static native int libsdkthreadidentifierjni_so();

   public static native int libsimplejni_so();

   public static native int libssim_so();

   public static native int libsslx_so();

   public static native int libstorer_jni_so();

   public static native int libstorer_so();

   public static native int libthird_party_libvpx_vpx_asm_so();

   public static native int libthreadutils_jni_so();

   public static native int libwebrtc_so();

   public static native int libxanalyticsadapter_jni_so();

   public static native int libxplat_caffe2_android_pytorch_jni_common_so();
